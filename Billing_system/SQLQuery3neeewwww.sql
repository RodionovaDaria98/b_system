...
FROM Biling_seans 
 JOIN Biling_abonent ON Biling_abonent.ID_Abonent=Biling_seans.Id_abonent_For_Seans 
 WHERE Surname_abonent LIKE '%%' AND Name_abonent LIKE '%ка%' AND Time_End > '10.08.2019' AND Time_End < DATEADD(month,1,'10.08.2019') 
